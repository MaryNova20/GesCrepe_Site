 ...
 */
public class demandeComite implements EtatAvecSomme {

    String matricule, nomprenom, salaire, datedemande, objetcredit, garantie,valeur, quotitecredit, quotitetotal, categorie;

    public demandeComite() {
    }

    public demandeComite(Object[] tab) {
    ...
    public Object construireTotal(Map<String, BigDecimal> mape) {
        demandeComite resultat = new demandeComite();
