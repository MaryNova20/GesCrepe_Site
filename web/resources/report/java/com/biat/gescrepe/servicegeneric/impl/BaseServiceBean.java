 ...
 */
package com.biat.gescrepe.servicegeneric.impl;
 ...
 * @author MENSAH Y.O.D
 */
public class BaseServiceBean<T extends Serializable, K > implements BaseServiceBeanLocal<T, K> {

    @PersistenceContext
    protected EntityManager em;
    private Class<T> type;

    public BaseServiceBean(Class<T> type) {
        this.type = type;
    }
